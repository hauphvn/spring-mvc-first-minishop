                        ...
                        <ul class="nofitications-dropdown">
                            ...
                            <li class="dropdown head-dpdn">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#">
                                        <div class="user_img"><img src='<c:url value="/resources/web-backend/images/in18.jpg"/> ' alt=""></div>
                                        <div class="notification_desc">
                                            <p>Lorem ipsum dolor</p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu" >
                ...
                <li id="menu-academico" ><a href="adminAddingProduct"><i class="fa fa-envelope nav_icon"></i><span>Sản phẩm</span><div class="clearfix"></div></a></li>
