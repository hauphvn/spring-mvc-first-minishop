                        ...
                        <li class="dropdown profile_details_drop">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <div class="profile_img">
                                    <span class="prfil-img"><img src='<c:url value="/resources/web-backend/images/in4.jpg"/> ' alt=""> </span>
                                    <div class="user-name">
                                        <p>Malorum</p>
                        ...
                        <div class="card-body p-b-20">
                            <div class="list-group">
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lg-item-img" src='<c:url value="/resources/web-backend/images/in1.jpg"/> ' alt="">
                                    </div>
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lg-item-img" src='<c:url value="/resources/web-backend/images/in2.jpg"/> ' alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="pull-left">
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lg-item-img" src='<c:url value="/resources/web-backend/images/in3.jpg"/> ' alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="pull-left">
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lg-item-img" src='<c:url value="/resources/web-backend/images/in4.jpg"/> ' alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="pull-left">
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu" >
                ...
                <li id="menu-academico" ><a href='<c:url value="/adminAddingProduct"/> '><i class="fa fa-cube"></i><span>Sản phẩm</span><div class="clearfix"></div></a></li>
